...
urlpatterns = [
    ...
    path('request/<int:pk>/', views.RegistrationRequest.as_view(), name="register_request"),
    path('request/<int:pk>/remove/', views.make_remove_boat_request, name="remove_boat"),
    path('request/<int:pk>/techCheck/', views. FirstTechCheck.as_view(), name="tech_check"),
    path('request/<int:pk>/yearTechCheck/', views.YearTechCheck.as_view(), name="year_tech_check"),
